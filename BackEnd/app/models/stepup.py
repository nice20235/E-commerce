...
from sqlalchemy import String, Integer, Boolean, DateTime, func, ForeignKey, Index, Numeric
...
class StepUp(Base):
    ...
    price: Mapped[Decimal] = mapped_column(Numeric(precision=12, scale=2), nullable=False, index=True)
